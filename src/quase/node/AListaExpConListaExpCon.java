...
public final class AListaExpConListaExpCon extends PListaExpCon
{
    private TVirg _virg_;
    private PExp _exp_;

    public AListaExpConListaExpCon()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListaExpConListaExpCon(
    ...
    {
        ((Analysis) sw).caseAListaExpConListaExpCon(this);
    }
