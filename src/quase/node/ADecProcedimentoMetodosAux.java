...
public final class ADecProcedimentoMetodosAux extends PMetodosAux
{
    private PDecProcedimento _decProcedimento_;

    public ADecProcedimentoMetodosAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecProcedimentoMetodosAux(
    ...
    {
        ((Analysis) sw).caseADecProcedimentoMetodosAux(this);
    }
