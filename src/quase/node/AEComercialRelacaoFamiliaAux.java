...
public final class AEComercialRelacaoFamiliaAux extends PFamiliaAux
{
    private TEComercial _eComercial_;
    private PRelacao _relacao_;

    public AEComercialRelacaoFamiliaAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEComercialRelacaoFamiliaAux(
    ...
    {
        ((Analysis) sw).caseAEComercialRelacaoFamiliaAux(this);
    }
