...
public final class AVirgInicializacaoAux extends PVirgInicializacaoAux
{
    private TVirg _virg_;
    private PInicializacao _inicializacao_;

    public AVirgInicializacaoAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVirgInicializacaoAux(
    ...
    {
        ((Analysis) sw).caseAVirgInicializacaoAux(this);
    }
