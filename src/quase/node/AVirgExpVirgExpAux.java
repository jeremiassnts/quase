...
public final class AVirgExpVirgExpAux extends PVirgExpAux
{
    private TVirg _virg_;
    private PExp _exp_;

    public AVirgExpVirgExpAux()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAVirgExpVirgExpAux(this);
    }
